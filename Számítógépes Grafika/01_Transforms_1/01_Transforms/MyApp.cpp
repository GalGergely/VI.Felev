...
void CMyApp::Update()
{
	...
	float f = SDL_GetTicks() / 1000.f;
	// nézeti transzformáció beállítása
	m_matView = glm::lookAt(glm::vec3( 5, 5, 0),		// honnan nézzük a színteret	   - eye
							//glm::vec3(0, 5, -5),		// honnan nézzük a színteret	   - eye
...
void CMyApp::Render()
{
	...
	*/
	...
	glDrawArrays(	GL_TRIANGLES,	// rajzoljunk ki háromszöglista primitívet
					...
					20);				// és 6db csúcspont segítségével rajzoljunk háromszöglistát
